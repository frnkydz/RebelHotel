...
public class StudentController {
	...
	public String create(@Valid FormStudent formStudent, BindingResult result,
		...
		UserAccount userAccount = new UserAccount(student,
				(new RandomPasswordGenerator()).generateRandomPassword(),
	...
	public String findStudentsByUserIdEquals(
			@RequestParam("userId") String userId, Model model) {
		model.addAttribute("students",
				Student.findStudentsByUserIdEquals(userId).getResultList());
		return "students/list";
	}
